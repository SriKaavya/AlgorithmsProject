...
temp_url = 'https://raw.githubusercontent.com/SriKaavya/AlgorithmsProject/master/temp_data.csv'
...
print(pd.head())
df_p.to_csv(r'/Users/srikaavya/Downloads/'+ user_input+'_Trial.csv', index = False, header=True)
pd.to_csv(r'/Users/srikaavya/Downloads/'+ user_input+'_Prediction.csv', index = False, header=True)